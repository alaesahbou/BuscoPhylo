...
include_once("paypal.class.php");
	...
	if(_GET('paypal')=='checkout'){
		...
		$products[0]['ItemName'] = $_SESSION['trans_name']; //Item Name
		$products[0]['ItemPrice'] = ($_SESSION['unit_amount']/100); //Item Price
		$products[0]['ItemNumber'] = "N/A"; //Item Number
		$products[0]['ItemDesc'] = "Deposit Money to Airxend Account"; //Item Number
