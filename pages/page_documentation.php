...
<head>
  ...
  <link rel="icon" href="icon/<?php echo AppIcon; ?>" sizes="32x32">
	...
	<title><?php echo AppName; ?> – Documentation</title>
...
?>
						...
						<li class="breadcrumb__item breadcrumb__item--active">Documentation</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="section section--pb0">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<p class="section__text section__text--small"><?php echo $Documentation; ?></p>
