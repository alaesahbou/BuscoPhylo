...
<head>
  ...
  <link rel="icon" href="icon/<?php echo AppIcon; ?>" sizes="32x32">
	...
	<title><?php echo AppName; ?> – Citation</title>
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-xl-6">
					<h1 class="section__title section__title--head nobr" >Citation</h1>
				</div>

				<div class="col-12 col-xl-6">
					<ul class="breadcrumb">
						<li class="breadcrumb__item"><a href="./">Home</a></li>
						<li class="breadcrumb__item breadcrumb__item--active">Citation</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="section section--pb0">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<p class="section__text section__text--small"><?php echo $citation; ?></p>
				</div>
