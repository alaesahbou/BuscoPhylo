<?php
if (isset($_GET['crt_ep'])) {
$ce = $_GET['crt_ep'];
}else{
$ce = "1";
}
$next_episode = 'item/'.$item_id.'/'.$item_title.'';
?>
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-8">
          ...
          <div class="article__actions article__actions--details">
            <div class="article__download">
              ...
              <?php
              if ($GLOBALS['streaming'] == "1") {
                ?><a href="#modal-links" class="open-modal">Episode Links</a>
                  ...
                  <table class="main__table main__table--dash">
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $stmt = $conn->prepare("SELECT * FROM tbl_episodes WHERE item = ? AND episode_no = ? ORDER BY size");
                                      $stmt->execute([$item_id, $ce]);
                                      $result = $stmt->fetchAll();
                  ...
                  <table class="main__table main__table--dash">
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $stmt = $conn->prepare("SELECT * FROM tbl_episode_subs WHERE item = ? ORDER BY language");
        ...
        <div class="col-12">
          <div class="series-wrap">
            <h3 class="series-wrap__title">Episodes</h3>
              ...
              <div class="section__series owl-carousel" id="series">
                ...
                try {
                  ...
                  foreach($result as $row)
                  {
                    ?>
                    <div class="series">
                      <a href="../../<?php echo $next_episode; ?>?crt_ep=<?php echo $row[5]; ?>" class="series__cover">
                        <img class="series_image" src="../../uploads/thumbnail/<?php echo $thumbnail; ?>" alt="">
                        <span>
                      ...
                      <h3 class="series__title"><a href="details.html.html">Episode <?php echo $row[5]; ?></a></h3>
                    </div>
                    <?php
                  }
